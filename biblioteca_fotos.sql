...
--
-- Host: localhost    Database: biblioteca_fotos
-- ------------------------------------------------------
...
INSERT INTO `autor` VALUES (1,'Guillermo del Toro');
...
CREATE TABLE `foto` (
  ...
  KEY `fk_foto_libro1_idx` (`libro_id`),
  CONSTRAINT `fk_foto_libro1` FOREIGN KEY (`libro_id`) REFERENCES `libro` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `foto` VALUES (1,'portada.jpg',NULL,NULL,1),(2,'contratapa.jpg',NULL,NULL,1),(3,'primera.jpg',NULL,NULL,1),(4,'portada.jpg',NULL,NULL,2);
...
INSERT INTO `libro` VALUES (1,200,'a12','editorial a','libro1'),(2,200,'a13','editorial a','libro2'),(3,200,'a14','editorial b','libro3'),(4,250,'a15','editorial a','libro4');
...
--
-- Dumping events for database 'biblioteca_fotos'
--
...
-- Dump completed on 2022-08-27 22:32:59
