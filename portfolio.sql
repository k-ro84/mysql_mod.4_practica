...
CREATE TABLE `experiencia_laboral` (
  ...
  `es_trab_actual` tinyint DEFAULT NULL,
  `fecha_inicio` date DEFAULT NULL,
  `fecha_fin` date DEFAULT NULL,
  `descripcion` varchar(200) DEFAULT NULL,
  `persona_id` int NOT NULL,
  PRIMARY KEY (`id`,`persona_id`),
  KEY `fk_experiencia_laboral_persona1_idx` (`persona_id`),
  CONSTRAINT `fk_experiencia_laboral_persona1` FOREIGN KEY (`persona_id`) REFERENCES `persona` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `persona` (
  ...
  `acerca_de_mi` varchar(200) DEFAULT NULL,
...
CREATE TABLE `tecnologias` (
  ...
  CONSTRAINT `fk_tecnologias_persona1` FOREIGN KEY (`persona_id`) REFERENCES `persona` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping events for database 'portfolio_web'
--
...
-- Dump completed on 2022-08-27 22:32:41
